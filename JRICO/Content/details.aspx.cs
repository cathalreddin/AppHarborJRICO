            ...
            if ((txtEmailDate.Text != "*") && (txtEmailDate.Text != "") && (txtEmailTo.Text != "") && (txtEmailSubject.Text != "") && (txtEmailContent.Text != ""))
            {
                ...
                using (SqlConnection conn = new SqlConnection(_connStr))
                {
                    try
                    {
                        ...
                        string result = newEmail.SendEmailToCathal(txtEmailTo.Text, "[New Email Trigger Set for Contract Title: " + lblContractTitle.Text + "] ", "EmailID: [" + lblEmailID.Text + " ]: " + txtEmailContent.Text + " Trigger Date: " + txtEmailDate.Text + " Contract Reference: " + lblContractReference.Text, Convert.ToDateTime(txtEmailDate.Text), id);
