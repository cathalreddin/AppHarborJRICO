...
<tr>
    ...
    <td align="center"> 
        <asp:Label ID="lblContractReferenceLabel" runat="server" Text="&nbsp;&nbsp; Contract Reference: " /> <asp:Label ID="lblContractReferenceHeading" runat="server" /> 
        <asp:Label ID="lblContractTitleLabel" runat="server" Text="&nbsp;&nbsp;|&nbsp;&nbsp; Contract Title: " /> <asp:Label ID="lblContractTitleHeading" runat="server" />
    <asp:HyperLink ID="hlMessage" runat="server" /></td>
    <td align="right">
        ...
        <td>
            ...
            <asp:MultiView ID="MainView" runat="server">
                <asp:View ID="View1" runat="server">
                    <asp:Table ID="Table1" runat="server" style="width: 100%; border-width: 1px; border-color: #666; border-style: solid; vertical-align: middle;">
                        <asp:TableRow>
                ...
                <asp:View ID="View2" runat="server">
                    ...
                    <asp:View ID="View4" runat="server">                        
                        <asp:Table ID="Table4" runat="server" Style="width: 100%; border-width: 1px; border-color: #666; border-style: solid; vertical-align: middle;">
                            <asp:TableRow>
                                <asp:TableCell>
                                   &nbsp;&nbsp; Search
                                    &nbsp;&nbsp;
                        ...
                        <asp:GridView ID="GridView4" runat="server" AllowSorting="True" OnSorting="SortRecordsPrice"
                            ...
                            ForeColor="Black" OnRowEditing="RowEditPrice" OnRowUpdating="RowUpdatePrice" OnRowCancelingEdit="RowEditCancelPrice"
                            Width="100%">
                            <Columns>
                                <asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Middle"
                                    ItemStyle-Wrap="false">
                                    <FooterTemplate>
                                        <asp:LinkButton ID="lbInsert" runat="server" ValidationGroup="insert" OnClick="lbInsert_Price">Insert</asp:LinkButton>
                                    </FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="Subject" SortExpression="Subject">
                                    ...
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtSubjectInsert" runat="server"></asp:TextBox>
                                        <asp:RequiredFieldValidator ValidationGroup="insertPrice" ID="rfcInsertSubject" runat="server"
                                ...
                                <asp:TemplateField HeaderText="Description" SortExpression="Description">
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <asp:RequiredFieldValidator ValidationGroup="insertPrice" ID="rfcInsertDescription" runat="server"
                                            ErrorMessage="Description is a required field!" ControlToValidate="txtDescriptionInsert"
                                            Text="*" ForeColor="Red">
                                        </asp:RequiredFieldValidator>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
                                ...
                                <asp:TemplateField HeaderText="Price" SortExpression="Price">
                                    <EditItemTemplate>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfcUpdatePrice" runat="server"
                                            ErrorMessage="Price is a required field!" ControlToValidate="txtPrice"
                                            Text="*" ForeColor="Red">
                                        </asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                    ...
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtPriceInsert" runat="server" Width="60"></asp:TextBox>
                                        <asp:RegularExpressionValidator ValidationGroup="insert" ID="revInsertPrice" runat="server" ErrorMessage="Only Decimal Value Allowed"
                                            ValidationExpression="^\d*[0-9](|.\d*[0-9]|,\d*[0-9])?$" ControlToValidate="txtPriceInsert"
                                            Text="*" ForeColor="Red">
                                        </asp:RegularExpressionValidator>
                                        <asp:RequiredFieldValidator ValidationGroup="insertPrice" ID="rfcInsertPrice" runat="server"
                        ...
                        <asp:ValidationSummary ID="ValidationSummary1" ValidationGroup="insertPrice" runat="server"
                            ForeColor="Red" />
                ...
                <asp:View ID="View5" runat="server">
                    ...
                    <asp:SqlDataSource ID="sdsHospitalName" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:SQLConnectionString %>" 
                        SelectCommand="SELECT [HospitalID], [HospitalName], [AccountNumber] FROM [Hospitals]"></asp:SqlDataSource>
                    <asp:GridView ID="GridView5" runat="server" AllowSorting="True" OnSorting="SortRecordsAccountNumber"
                        ...
                        <Columns>
                            <asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Middle"
                                ItemStyle-Wrap="false">
                                <FooterTemplate>
                                    <asp:LinkButton ID="lbInsert" runat="server" ValidationGroup="insert" OnClick="lbInsert_AccountNumber">Insert</asp:LinkButton>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False"></ItemStyle>
                            </asp:TemplateField>
                    ...
                    <asp:ValidationSummary ID="ValidationSummary3" ValidationGroup="insertAccountNumber" runat="server"
                        ForeColor="Red" />
                    </asp:View>
                </asp:MultiView>
            </td>
